// Logic test script for the modified playAlarmDirectly function
console.log("Testing modified playAlarmDirectly function logic...");
...
class MockAudio {
  constructor(url) {
    ...
    this.volume = 1.0;
    this.loop = false;
    console.log(`Mock Audio created with URL: ${url}`);
  }

  play() {
    return new Promise((resolve, reject) => {
      console.log(`Mock Audio playing: ${this.url}`);
...
function playAlarmDirectly() {
  ...
  const currentAudio = new MockAudio(audioUrl);
